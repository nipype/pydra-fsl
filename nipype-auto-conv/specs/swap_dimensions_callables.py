"""Module to put any functions that are referred to in the "callables" section of SwapDimensions.yaml"""
...
# Original source at L1642 of <nipype-install>/interfaces/fsl/utils.py
...
# Original source at L1632 of <nipype-install>/interfaces/fsl/utils.py
