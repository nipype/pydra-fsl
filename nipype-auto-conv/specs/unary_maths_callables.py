"""Module to put any functions that are referred to in the "callables" section of UnaryMaths.yaml"""
...
# Original source at L61 of <nipype-install>/interfaces/fsl/maths.py
def _gen_filename(name, inputs=None, stdout=None, stderr=None, output_dir=None):
    if name == "out_file":
        return nipype_interfaces_fsl_maths__MathsCommand___list_outputs(
...
# Original source at L502 of <nipype-install>/interfaces/fsl/maths.py
def _list_outputs(inputs=None, stdout=None, stderr=None, output_dir=None):
    _suffix = "_" + inputs.operation
    return nipype_interfaces_fsl_maths__MathsCommand___list_outputs()
...
# Original source at L51 of <nipype-install>/interfaces/fsl/maths.py
def nipype_interfaces_fsl_maths__MathsCommand___list_outputs(
