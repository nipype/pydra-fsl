"""Module to put any functions that are referred to in the "callables" section of DTIFit.yaml"""
...
# Original source at L114 of <nipype-install>/interfaces/fsl/dti.py
