"""Module to put any functions that are referred to in the "callables" section of BEDPOSTX5.yaml"""
...
def dyads_dispersion_callable(output_dir, inputs, stdout, stderr):
    ...
    return outputs["dyads_dispersion"]
...
def merged_fsamples_callable(output_dir, inputs, stdout, stderr):
    ...
    return outputs["merged_fsamples"]
...
def merged_phsamples_callable(output_dir, inputs, stdout, stderr):
    ...
    return outputs["merged_phsamples"]
...
def merged_thsamples_callable(output_dir, inputs, stdout, stderr):
    ...
    return outputs["merged_thsamples"]
...
# Original source at L483 of <nipype-install>/interfaces/fsl/dti.py
