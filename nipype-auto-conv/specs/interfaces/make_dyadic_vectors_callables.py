"""Module to put any functions that are referred to in the "callables" section of MakeDyadicVectors.yaml"""
...
# Original source at L1571 of <nipype-install>/interfaces/fsl/dti.py
