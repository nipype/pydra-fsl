"""Module to put any functions that are referred to in the "callables" section of ExtractROI.yaml"""
...
def roi_file_callable(output_dir, inputs, stdout, stderr):
    outputs = _list_outputs(
        output_dir=output_dir, inputs=inputs, stdout=stdout, stderr=stderr
    )
    return outputs["roi_file"]


IFLOGGER = logging.getLogger("nipype.interface")


# Original source at L513 of <nipype-install>/interfaces/fsl/utils.py
...
# Original source at L489 of <nipype-install>/interfaces/fsl/utils.py
def _list_outputs(inputs=None, stdout=None, stderr=None, output_dir=None):
    ...
    """
    outputs = {}
    outputs["roi_file"] = inputs.roi_file
