"""Module to put any functions that are referred to in the "callables" section of FilterRegressor.yaml"""
...
# Original source at L731 of <nipype-install>/interfaces/fsl/utils.py
...
# Original source at L721 of <nipype-install>/interfaces/fsl/utils.py
