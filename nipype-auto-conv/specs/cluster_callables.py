"""Module to put any functions that are referred to in the "callables" section of Cluster.yaml"""
...
def localmax_txt_file_callable(output_dir, inputs, stdout, stderr):
    ...
    return outputs["localmax_txt_file"]
...
def localmax_vol_file_callable(output_dir, inputs, stdout, stderr):
    ...
    return outputs["localmax_vol_file"]
...
# Original source at L2074 of <nipype-install>/interfaces/fsl/model.py
