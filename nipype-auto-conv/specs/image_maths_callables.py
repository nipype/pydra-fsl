"""Module to put any functions that are referred to in the "callables" section of ImageMaths.yaml"""
...
# Original source at L627 of <nipype-install>/interfaces/fsl/utils.py
...
# Original source at L635 of <nipype-install>/interfaces/fsl/utils.py
def _list_outputs(inputs=None, stdout=None, stderr=None, output_dir=None):
    suffix = "_maths"  # ohinds: build suffix
    if inputs.suffix is not attrs.NOTHING:
