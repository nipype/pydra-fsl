"""Module to put any functions that are referred to in the "callables" section of ImageMeants.yaml"""
...
# Original source at L184 of <nipype-install>/interfaces/fsl/utils.py
...
# Original source at L174 of <nipype-install>/interfaces/fsl/utils.py
