"""Module to put any functions that are referred to in the "callables" section of PlotTimeSeries.yaml"""
...
# Original source at L1367 of <nipype-install>/interfaces/fsl/utils.py
...
# Original source at L1355 of <nipype-install>/interfaces/fsl/utils.py
