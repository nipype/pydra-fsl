...
def slice_time_corrected_file_callable(output_dir, inputs, stdout, stderr):
    ...
    return outputs["slice_time_corrected_file"]


IFLOGGER = logging.getLogger("nipype.interface")


# Original source at L1578 of <nipype-install>/interfaces/fsl/preprocess.py
...
# Original source at L1570 of <nipype-install>/interfaces/fsl/preprocess.py
