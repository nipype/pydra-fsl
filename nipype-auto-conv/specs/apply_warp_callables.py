"""Module to put any functions that are referred to in the "callables" section of ApplyWarp.yaml"""
...
# Original source at L1494 of <nipype-install>/interfaces/fsl/preprocess.py
...
# Original source at L1486 of <nipype-install>/interfaces/fsl/preprocess.py
