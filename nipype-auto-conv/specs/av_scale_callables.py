"""Module to put any functions that are referred to in the "callables" section of AvScale.yaml"""
...
def backward_half_transform_callable(output_dir, inputs, stdout, stderr):
    ...
    return outputs["backward_half_transform"]
...
def forward_half_transform_callable(output_dir, inputs, stdout, stderr):
    ...
    return outputs["forward_half_transform"]
...
# Original source at L935 of <nipype-install>/interfaces/fsl/utils.py
