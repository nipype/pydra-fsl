"""Module to put any functions that are referred to in the "callables" section of Slicer.yaml"""
...
# Original source at L1246 of <nipype-install>/interfaces/fsl/utils.py
...
# Original source at L1238 of <nipype-install>/interfaces/fsl/utils.py
