"""Module to put any functions that are referred to in the "callables" section of SigLoss.yaml"""
...
# Original source at L1750 of <nipype-install>/interfaces/fsl/utils.py
...
# Original source at L1741 of <nipype-install>/interfaces/fsl/utils.py
