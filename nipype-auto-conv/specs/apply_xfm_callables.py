"""Module to put any functions that are referred to in the "callables" section of ApplyXFM.yaml"""
...
def out_matrix_file_callable(output_dir, inputs, stdout, stderr):
    outputs = _list_outputs(
        output_dir=output_dir, inputs=inputs, stdout=stdout, stderr=stderr
    )
    return outputs["out_matrix_file"]
