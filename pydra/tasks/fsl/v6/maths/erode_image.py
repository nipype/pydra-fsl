...
def minimum_filter_formatter(field, inputs):
    return _format_arg("minimum_filter", field, inputs, argstr="{minimum_filter:d}")
...
class ErodeImage(shell.Task["ErodeImage.Outputs"]):
    """
    Examples
    -------
