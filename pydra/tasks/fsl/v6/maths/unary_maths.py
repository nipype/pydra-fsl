...
@shell.define
class UnaryMaths(shell.Task["UnaryMaths.Outputs"]):
    """
    Examples
    -------
...
def _list_outputs(in_file=None, operation=None, out_file=None, output_type=None):
    _suffix = attrs.NOTHING
    self_dict = {}
    outputs = {}
    ...
    return outputs, _suffix


def _list_outputs(in_file=None, operation=None, out_file=None, output_type=None):
    _suffix = attrs.NOTHING
    self_dict = {}
    self_dict["_suffix"] = "_" + operation
    return _list_outputs(), _suffix
